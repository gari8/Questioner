...
func HasParent() predicate.Choice {
	return predicate.Choice(func(s *sql.Selector) {
...
func HasParentWith(preds ...predicate.Question) predicate.Choice {
	return predicate.Choice(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasChoiceanswers() predicate.Choice {
	return predicate.Choice(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasChoiceanswersWith(preds ...predicate.ChoiceAnswer) predicate.Choice {
	return predicate.Choice(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
